...
<template>
  ...
  <!-- Scrollable -->
  <!-- ----------------------------------------------------------------------------- -->
  <p class="text-caption text-grey-darken-1">Example of a dialog with scrollable content.</p>
  <div class="text-center mt-6">
    <v-dialog v-model="dialog" scrollable width="320">
      <template #activator="{props}">
        <v-btn color="secondary" variant="flat" v-bind="props"> Open Dialog </v-btn>
      </template>
      <v-card>
