...
<template>
  <v-table class="bordered-table" hover density="comfortable">
    <thead class="bg-containerBg">
      <tr>
        <th class="text-start text-caption font-weight-bold text-uppercase">Assigned</th>
        ...
        <th class="text-end text-caption font-weight-bold text-uppercase">Priority</th>
      </tr>
    </thead>
    <tbody>
