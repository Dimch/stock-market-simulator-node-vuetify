        ...
        <v-col cols="12" sm="6">
          <UiParentCard title="Slide X Transition">
            ...
            <v-slide-x-transition>
              <img src="@/assets/images/background/img-profile-bg.png" alt="Dimch" v-show="slidxTran" class="rounded-md mt-8 w-75" />
            </v-slide-x-transition>
          </UiParentCard>
        </v-col>
        <v-col cols="12" sm="6">
          <UiParentCard title="Slide y Transition">
            ...
            <v-slide-y-transition>
              <img src="@/assets/images/background/img-profile-bg.png" alt="Dimch" v-show="slidyTran" class="rounded-md mt-8 w-75" />
            </v-slide-y-transition>
          </UiParentCard>
        </v-col>
        <v-col cols="12" sm="6">
          <UiParentCard title="Scroll x Transition">
            ...
            <v-scroll-x-transition>
              <img src="@/assets/images/background/img-profile-bg.png" alt="Dimch" v-show="scrolTran" class="rounded-md mt-8 w-75" />
            </v-scroll-x-transition>
          </UiParentCard>
        </v-col>
        <v-col cols="12" sm="6">
          <UiParentCard title="Scroll y Transition">
            ...
            <v-scroll-y-transition>
              <img src="@/assets/images/background/img-profile-bg.png" alt="Dimch" v-show="scrolyTran" class="rounded-md mt-8 w-75" />
            </v-scroll-y-transition>
          </UiParentCard>
        </v-col>
        <v-col cols="12" sm="6">
          <UiParentCard title="Expand Transition">
            ...
            <br />
            <v-expand-transition>
              <img src="@/assets/images/background/img-profile-bg.png" alt="Dimch" v-show="expandTran" class="rounded-md mt-8 w-75" />
            </v-expand-transition>
          </UiParentCard>
        </v-col>
        <v-col cols="12" sm="6">
          <UiParentCard title="Fab Transition">
            ...
            <br />
            <v-fab-transition>
              <img src="@/assets/images/background/img-profile-bg.png" alt="Dimch" v-show="fabTran" class="rounded-md mt-8 w-75" />
            </v-fab-transition>
          </UiParentCard>
        </v-col>
        <v-col cols="12" sm="6">
          <UiParentCard title="Fade Transition">
            ...
            <br />
            <v-fade-transition>
              <img src="@/assets/images/background/img-profile-bg.png" alt="Dimch" v-show="fadeTran" class="rounded-md mt-8 w-75" />
            </v-fade-transition>
          </UiParentCard>
        </v-col>
      </v-row>
