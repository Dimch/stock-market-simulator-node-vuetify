...
// Icons
import {PlusOutlined, HeartOutlined, ShareAltOutlined, PrinterOutlined, BookOutlined} from '@ant-design/icons-vue';
...
const selectedItem = ref('bottom');
const selectedItem2 = ref('center');

// Define arrays of valid locations
const itemsAndLocations = ['top', 'bottom', 'left', 'right'];
const itemsAndLocations2 = ['top', 'bottom', 'center', 'left', 'right'];
...
// Concatenate two locations into one valid Anchor-like string
const getLocation = (loc1, loc2) => {
  const validLocations = ['top', 'bottom', 'left', 'right', 'center'];
  const parts = [loc1, loc2].filter((loc) => validLocations.includes(loc));
        ...
        <v-col cols="12" md="6">
          <UiParentCard title="Default">
            <v-sheet height="205" class="fab-icon text-center mt-4">
              <v-fab size="large" color="primary" rounded="circle" min-width="50" class="h-auto" height="50">
                <PlusOutlined />
                <v-speed-dial
