...
create schema staff;
comment on schema staff is 'Website''s administration console related data, e.g. users and rate limits';
...
comment on table staff.users is 'Administration staff';
