...
comment on schema market is 'SStock market specific data, e.g. list of stocks and prices';
...
comment on table market.stocks is 'List of stocks available on the market';
